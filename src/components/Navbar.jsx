    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      >
        <div className="flex flex-col text-gray-600">
         ...
         <NavLink onClick={()=>setVisible(false)} className="py-2 pl-6 text-sm border-b border-gray-200" to="/">
            HOME
            </NavLink>
        <NavLink onClick={()=>setVisible(false)} className="py-2 pl-6 text-sm border-b border-gray-200" to="/collection">
            COLLECTION
        </NavLink>
        <NavLink onClick={()=>setVisible(false)} className="py-2 pl-6 text-sm border-b border-gray-200" to="/about">
         ABOUT
        </NavLink>
        <NavLink onClick={()=>setVisible(false)} className="py-2 pl-6 text-sm border-b border-gray-200" to="/contact">
          CONTACT
        </NavLink>
        </div>
      </div>
